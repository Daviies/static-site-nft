...
const toggleMenu = () => {
    ...
    document.body.classList.toggle('scroll_false')
}
...
window.addEventListener('resize', () => {
    if(this.innerWidth >= 1024) if(menuEl.classList.contains('active')) toggleMenu()
})

// 64 em = 1024 // 48 em = 768px 
...
sr.reveal('.showcase_text_group',{
        origin: 'top'
    }
)

sr.reveal('.showcase_image_group',{
      origin: 'bottom'
    }
)